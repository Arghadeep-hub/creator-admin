...
function getTierLabel(rank: number): { key: string; label: string } {
  if (rank <= 3) return { key: 'gold', label: 'Gold' }
  if (rank <= 10) return { key: 'silver', label: 'Silver' }
      ...
      {entries.map((entry, index) => {
        ...
        return (
          ...
          >
            ...
            <Avatar name={entry.creator.name} size="sm" />
            ...
            <div className="flex items-center gap-3 shrink-0">
              <div className="text-right">
                ...
                <Badge
                  variant={tier.key === 'gold' ? 'warning' : tier.key === 'silver' ? 'secondary' : 'gray'}
